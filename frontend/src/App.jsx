...
export default function App() {
  const { user, token, isAuthenticated, login, logout, loading, error } = useAuthStore();
  ...
  // Login form states
  const [loginEmail, setLoginEmail] = useState('admin@rmgtrace.com');
  const [loginPass, setLoginPass] = useState('Admin@123456');

  // Admin management lists from live API
  ...
  // Fetch admin lists when authenticated
  ...
  return (
    <div className={`min-h-screen transition-colors duration-300 flex flex-col font-sans selection:bg-cyan-500 selection:text-black ${
          ...
          <div className="flex items-center space-x-3">
            ...
            {isAuthenticated ? (
              ...
              <button
                ...
                className="px-4 py-2 rounded-xl bg-gradient-to-r from-cyan-500 to-blue-600 hover:from-cyan-400 hover:to-blue-500 text-white text-xs font-bold shadow-md shadow-cyan-500/20 flex items-center space-x-1.5 cursor-pointer transition-all"
              >
      ...
      <main className="flex-1 max-w-7xl w-full mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-12">
        ...
        {/* If Authenticated: Show Module 01 Live Administration Portal */}
        {isAuthenticated && (
          <section className={`p-6 sm:p-8 rounded-3xl border transition-all ${
            ...
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 pb-6 border-b border-slate-700/30">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  <div className="flex items-center space-x-2">
                    <span className="text-xs font-bold font-mono px-2 py-0.5 rounded bg-cyan-500/20 text-cyan-400">
                      MODULE 01 LIVE CONSOLE
                    </span>
                    <span className="text-xs text-emerald-400 font-semibold">&bull; Protected Admin Hub</span>
                  </div>
              ...
              <div className="mt-6 space-y-4">
                <div className="flex items-center justify-between">
                  ...
                  <button
                    ...
                    className="px-3.5 py-1.5 rounded-xl bg-cyan-500 hover:bg-cyan-400 text-black text-xs font-bold flex items-center space-x-1.5 shadow-md cursor-pointer transition-all"
                  >
        ...
        <div className="fixed inset-0 z-50 bg-black/70 backdrop-blur-sm flex items-center justify-center p-4">
          <div className={`max-w-md w-full rounded-3xl p-6 sm:p-8 border shadow-2xl relative ${
            ...
            <div className="flex items-center space-x-3 mb-5">
              <div className="p-3 bg-gradient-to-tr from-cyan-500 to-blue-600 rounded-2xl text-white">
                <Lock className="h-6 w-6" />
              </div>
              <div>
                <h3 className="text-lg font-bold">Admin Console Login</h3>
                <p className="text-xs text-slate-400">Enter your credentials to manage RBAC & floor devices</p>
              </div>
            </div>
            ...
            <form onSubmit={handleLoginSubmit} className="space-y-4">
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    required
                    className={`w-full pl-9 pr-4 py-2 rounded-xl text-xs border focus:outline-none focus:ring-2 focus:ring-cyan-500 ${
              ...
              <div className="flex items-center space-x-3 pt-2">
                ...
                <button
                  type="submit"
                  disabled={loading}
                  className="flex-1 py-2 rounded-xl bg-gradient-to-r from-cyan-500 to-blue-600 hover:from-cyan-400 hover:to-blue-500 text-white text-xs font-bold shadow-md cursor-pointer disabled:opacity-50"
                >
