...
**Module:** 01 - Master Data (Global Library)
...
- **Rule 1 (Tablet Mapping):** When configuring an Android Tablet in Module 11, it must be mapped to an Active `Line_ID`. If a line is marked `Inactive`, the tablet mapped to it will force log out.
