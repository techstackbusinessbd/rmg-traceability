...
## 1. Executive Summary
This module connects the Confirmed POs from Merchandising (Module 02) to the physical Factory Floor. The Industrial Engineering (IE) team allocates the PO to specific Sewing Lines based on mathematical capacity. 
...
- When the IE Manager clicks "Lock Plan", the Planning Module internally queries the Store Module (Module 10) for the required materials.
