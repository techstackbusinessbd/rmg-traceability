...
class SystemSettingService
{
    ...
    public function seedDefaults(): void
    {
        $defaults = [
            ...
            [
                'group' => 'production',
                'key' => 'ie_operational_mode',
                'value' => 'IE_ENABLED',
                'type' => 'select',
                'options' => ['IE_ENABLED', 'WITHOUT_IE_STANDARD'],
                'label' => 'Industrial Engineering (IE) Workflow Control',
                'description' => 'Determines whether lines require SMV / Operation Bulletins (IE_ENABLED) or operate in Direct Line Output mode (WITHOUT_IE_STANDARD).',
                'is_public' => true,
            ],
            [
                'group' => 'production',
                'key' => 'ie_mandatory_smv_for_scheduling',
                'value' => 'true',
                'type' => 'boolean',
                'options' => null,
                'label' => 'Mandatory SMV for Line Plan Allocation',
                'description' => 'When enabled, styles cannot be scheduled to sewing lines without an approved SMV from the IE Department.',
                'is_public' => true,
            ],
            [
                'group' => 'production',
                'key' => 'ie_workstation_operator_scan',
                'value' => 'false',
                'type' => 'boolean',
                'options' => null,
                'label' => 'Individual Operator Workstation Scanning',
                'description' => 'Enables granular piece-rate / operator efficiency tracking per operation instead of bundle-only line tracking.',
                'is_public' => true,
            ],
            [
                'group' => 'production',
